...
from src.training.utils import extract_patches
...
class SynthesisNetwork(torch.nn.Module):
    ...
    def forward(self, ws, camera_angles=None, patch_params=None, **block_kwargs):
        ...
        if self.training and not patch_params is None:
            img = extract_patches(img, patch_params, resolution=self.cfg.patch.resolution, strategy=self.cfg.patch.strategy) # [batch_size, c, h_patch, w_patch]
