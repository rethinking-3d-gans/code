...
class SynthesisBlock(torch.nn.Module):
    def __init__(self,
        ...
        **layer_kwargs,                     # Arguments for SynthesisLayer.
        ...
        if in_channels == 0:
            ...
            self.conv0 = SynthesisLayer(in_channels, out_channels, w_dim=w_dim, conv_clamp=conv_clamp, cfg=cfg, **layer_kwargs)
            self.num_layers += 1
            conv1_in_channels = out_channels

        self.conv1 = SynthesisLayer(conv1_in_channels, out_channels, w_dim=w_dim, conv_clamp=conv_clamp, cfg=cfg, **layer_kwargs)
        self.num_layers += 1
    ...
    def forward(self, x, out, ws, force_fp32=False, **layer_kwargs):
